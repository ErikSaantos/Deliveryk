...
Revision ID: 577e72891228
Revises: 
Create Date: 2026-01-17 23:10:43.398289
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDENTE', 'CANCELADO', 'FINALIZADO', name='status_pedido_enum'), nullable=True),
    ...
    sa.Column('tipo_borda', sa.String(), nullable=True),
